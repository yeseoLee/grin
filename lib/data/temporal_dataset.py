...
class TemporalDataset(Dataset):
    ...
    def add_exogenous(self, obj, name, for_window=True, for_horizon=False):
        ...
        self.__exogenous_keys[name] = {"for_window": for_window, "for_horizon": for_horizon}
        return self
    ...
    def signature(self):
        ...
        return {"data": attrs, "preprocessing": preprocess}
    ...
    def expand_indices(self, indices=None, unique=False, merge=False):
        ...
        if "horizon" in ds_indices:
            h_idxs = [
                np.arange(idx + self.horizon_offset, idx + self.horizon_offset + self.horizon)
